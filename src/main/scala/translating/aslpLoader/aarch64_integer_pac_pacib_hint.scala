...
def f_aarch64_integer_pac_pacib_hint (v_st: LiftState,v_enc: BV) : Unit = {
  ...
  if (f_eq_bits(v_st, BigInt(7), f_append_bits(v_st, BigInt(4), BigInt(3), bvextract(v_st,v_enc,BigInt(8),BigInt(4)), bvextract(v_st,v_enc,BigInt(5),BigInt(3))), mkBits(v_st, 7, BigInt("0011010", 2)))) then {
    v_d__1.v = mkBits(v_st, 5, BigInt("11110", 2))
    v_n__1.v = mkBits(v_st, 5, BigInt("11111", 2))
  } else {
    if (f_eq_bits(v_st, BigInt(7), f_append_bits(v_st, BigInt(4), BigInt(3), bvextract(v_st,v_enc,BigInt(8),BigInt(4)), bvextract(v_st,v_enc,BigInt(5),BigInt(3))), mkBits(v_st, 7, BigInt("0011011", 2)))) then {
      v_d__1.v = mkBits(v_st, 5, BigInt("11110", 2))
      ...
      if (f_eq_bits(v_st, BigInt(7), f_append_bits(v_st, BigInt(4), BigInt(3), bvextract(v_st,v_enc,BigInt(8),BigInt(4)), bvextract(v_st,v_enc,BigInt(5),BigInt(3))), mkBits(v_st, 7, BigInt("0001010", 2)))) then {
