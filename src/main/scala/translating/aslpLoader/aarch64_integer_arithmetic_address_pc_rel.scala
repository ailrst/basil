...
def f_aarch64_integer_arithmetic_address_pc_rel (v_st: LiftState,v_enc: BitVecLiteral) : Unit = {
  if (f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(31),BigInt(1)), BitVecLiteral(BigInt("1", 2), 1))) then {
    if (f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(31),BigInt(1)), BitVecLiteral(BigInt("1", 2), 1))) then {
      ...
      if (f_ne_bits(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BitVecLiteral(BigInt("11111", 2), 5))) then {
        f_gen_array_store (v_st,v__R.v,f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(0),BigInt(5))),f_gen_add_bits(v_st, BigInt(64), f_gen_append_bits(v_st, BigInt(52), BigInt(12), f_gen_slice(v_st, f_gen_load(v_st, v__PC.v), BigInt(12), BigInt(52)), f_gen_bit_lit(v_st, BigInt(12), BitVecLiteral(BigInt("000000000000", 2), 12))), f_gen_bit_lit(v_st, BigInt(64), f_SignExtend(v_st, BigInt(33), BigInt(64), f_append_bits(v_st, BigInt(21), BigInt(12), f_append_bits(v_st, BigInt(19), BigInt(2), bvextract(v_st,v_enc,BigInt(5),BigInt(19)), bvextract(v_st,v_enc,BigInt(29),BigInt(2))), BitVecLiteral(BigInt("000000000000", 2), 12)), BigInt(64)))))
      }
    } else {
      assert (((f_sle_bits(v_st, BigInt(6), BitVecLiteral(BigInt("000000", 2), 6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)), BitVecLiteral(BigInt("011111", 2), 6)))))
      if (f_ne_bits(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BitVecLiteral(BigInt("11111", 2), 5))) then {
