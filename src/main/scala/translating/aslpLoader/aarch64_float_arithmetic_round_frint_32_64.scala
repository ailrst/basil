  ...
  if (v_Exp5__1) then {
    ...
    if (v_Exp22__1) then {
      ...
      if (f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(15),BigInt(1)), mkBits(v_st, 1, BigInt("0", 2)))) then {
        ...
        val v_FPDecodeRounding27__3 : RTSym = f_decl_bv(v_st, "FPDecodeRounding27__3", BigInt(3)) 
        ...
        f_gen_store (v_st,v_FPDecodeRounding27__3,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("000", 2))))
        ...
        f_gen_store (v_st,v_FPDecodeRounding27__3,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("001", 2))))
        ...
        f_gen_store (v_st,v_FPDecodeRounding27__3,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("010", 2))))
        ...
        f_gen_store (v_st,v_FPDecodeRounding27__3,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("011", 2))))
        f_switch_context (v_st,f_false_branch(v_st, v_temp7))
        f_gen_assert (v_st,f_gen_bool_lit(v_st, false))
        f_switch_context (v_st,f_merge_branch(v_st, v_temp4))
        v_If24__1.v = f_gen_load(v_st, v_FPDecodeRounding27__3)
      }
      assert (((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(5),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(5),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2))))))
