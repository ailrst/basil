...
def f_aarch64_vector_reduce_fp16_maxnm_sisd (v_st: LiftState,v_enc: BitVecLiteral) : Unit = {
  if (f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(22),BigInt(1)), BitVecLiteral(BigInt("1", 2), 1))) then {
    ...
    if (f_eq_bits(v_st, BigInt(3), v_If4__1.v, BitVecLiteral(BigInt("000", 2), 3))) then {
      val v_Exp12__3 : RTSym = f_decl_bv(v_st, "Exp12__3", BigInt(16)) 
      f_gen_store (v_st,v_Exp12__3,f_gen_FPMinNum(v_st, BigInt(16), f_gen_slice(v_st, f_gen_array_load(v_st, v__Z.v, f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(5),BigInt(5)))), BigInt(0), BigInt(16)), f_gen_slice(v_st, f_gen_array_load(v_st, v__Z.v, f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(5),BigInt(5)))), BigInt(16), BigInt(16)), f_gen_load(v_st, v_FPCR.v)))
      ...
      if (f_eq_bits(v_st, BigInt(3), v_If4__1.v, BitVecLiteral(BigInt("001", 2), 3))) then {
        val v_Exp14__3 : RTSym = f_decl_bv(v_st, "Exp14__3", BigInt(16)) 
        ...
        if (f_eq_bits(v_st, BigInt(3), v_If4__1.v, BitVecLiteral(BigInt("010", 2), 3))) then {
          ...
          f_gen_store (v_st,v_Exp16__3,f_gen_FPMin(v_st, BigInt(16), f_gen_slice(v_st, f_gen_array_load(v_st, v__Z.v, f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(5),BigInt(5)))), BigInt(0), BigInt(16)), f_gen_slice(v_st, f_gen_array_load(v_st, v__Z.v, f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(5),BigInt(5)))), BigInt(16), BigInt(16)), f_gen_load(v_st, v_FPCR.v)))
          ...
          if (f_eq_bits(v_st, BigInt(3), v_If4__1.v, BitVecLiteral(BigInt("011", 2), 3))) then {
            val v_Exp18__3 : RTSym = f_decl_bv(v_st, "Exp18__3", BigInt(16)) 
            ...
            if (f_eq_bits(v_st, BigInt(3), v_If4__1.v, BitVecLiteral(BigInt("100", 2), 3))) then {
              val v_Exp20__3 : RTSym = f_decl_bv(v_st, "Exp20__3", BigInt(16)) 
              f_gen_store (v_st,v_Exp20__3,f_gen_FPAdd(v_st, BigInt(16), f_gen_slice(v_st, f_gen_array_load(v_st, v__Z.v, f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(5),BigInt(5)))), BigInt(0), BigInt(16)), f_gen_slice(v_st, f_gen_array_load(v_st, v__Z.v, f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(5),BigInt(5)))), BigInt(16), BigInt(16)), f_gen_load(v_st, v_FPCR.v)))
              ...
              if (f_eq_bits(v_st, BigInt(3), v_If4__1.v, BitVecLiteral(BigInt("101", 2), 3))) then {
                f_gen_store (v_st,v_result__2,f_gen_add_bits(v_st, BigInt(16), f_gen_slice(v_st, f_gen_array_load(v_st, v__Z.v, f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(5),BigInt(5)))), BigInt(0), BigInt(16)), f_gen_slice(v_st, f_gen_array_load(v_st, v__Z.v, f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(5),BigInt(5)))), BigInt(16), BigInt(16))))
              } else {
                throw Exception("not supported")
              }
            }
    ...
    f_gen_array_store (v_st,v__Z.v,f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(0),BigInt(5))),f_gen_ZeroExtend(v_st, BigInt(16), BigInt(128), f_gen_load(v_st, v_result__2), f_gen_int_lit(v_st, BigInt(128))))
  }
}
