...
def f_aarch64_vector_arithmetic_unary_float_widen (v_st: LiftState,v_enc: BV) : Unit = {
  if (f_eq_bits(v_st, BigInt(1), mkBits(v_st, 1, BigInt("0", 2)), bvextract(v_st,v_enc,BigInt(22),BigInt(1)))) then {
    ...
    f_gen_store (v_st,v_FPDecodeRounding21__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("000", 2))))
    ...
    f_gen_store (v_st,v_FPDecodeRounding21__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("001", 2))))
    ...
    f_gen_store (v_st,v_FPDecodeRounding21__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("010", 2))))
    ...
    f_gen_store (v_st,v_FPDecodeRounding21__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("011", 2))))
    f_switch_context (v_st,f_false_branch(v_st, v_temp3))
    f_gen_assert (v_st,f_gen_bool_lit(v_st, false))
    f_switch_context (v_st,f_merge_branch(v_st, v_temp0))
    val v_Exp23__3 : RTSym = f_decl_bv(v_st, "Exp23__3", BigInt(32)) 
    f_gen_store (v_st,v_Exp23__3,f_gen_FPConvert(v_st, BigInt(32), BigInt(16), f_gen_slice(v_st, v_Vpart_read5__2.v, BigInt(0), BigInt(16)), f_gen_load(v_st, v_FPCR.v), f_gen_cvt_bits_uint(v_st, BigInt(3), f_gen_load(v_st, v_FPDecodeRounding21__4))))
    ...
    f_gen_store (v_st,v_FPDecodeRounding28__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("000", 2))))
    ...
    f_gen_store (v_st,v_FPDecodeRounding28__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("001", 2))))
    ...
    f_gen_store (v_st,v_FPDecodeRounding28__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("010", 2))))
    ...
    f_gen_store (v_st,v_FPDecodeRounding28__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("011", 2))))
    f_switch_context (v_st,f_false_branch(v_st, v_temp7))
    f_gen_assert (v_st,f_gen_bool_lit(v_st, false))
    f_switch_context (v_st,f_merge_branch(v_st, v_temp4))
    val v_Exp30__3 : RTSym = f_decl_bv(v_st, "Exp30__3", BigInt(32)) 
    f_gen_store (v_st,v_Exp30__3,f_gen_FPConvert(v_st, BigInt(32), BigInt(16), f_gen_slice(v_st, v_Vpart_read5__2.v, BigInt(16), BigInt(16)), f_gen_load(v_st, v_FPCR.v), f_gen_cvt_bits_uint(v_st, BigInt(3), f_gen_load(v_st, v_FPDecodeRounding28__4))))
    ...
    f_gen_store (v_st,v_FPDecodeRounding35__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("000", 2))))
    ...
    f_gen_store (v_st,v_FPDecodeRounding35__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("001", 2))))
    ...
    f_gen_store (v_st,v_FPDecodeRounding35__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("010", 2))))
    ...
    f_gen_store (v_st,v_FPDecodeRounding35__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("011", 2))))
    f_switch_context (v_st,f_false_branch(v_st, v_temp11))
    f_gen_assert (v_st,f_gen_bool_lit(v_st, false))
    f_switch_context (v_st,f_merge_branch(v_st, v_temp8))
    val v_Exp37__3 : RTSym = f_decl_bv(v_st, "Exp37__3", BigInt(32)) 
    f_gen_store (v_st,v_Exp37__3,f_gen_FPConvert(v_st, BigInt(32), BigInt(16), f_gen_slice(v_st, v_Vpart_read5__2.v, BigInt(32), BigInt(16)), f_gen_load(v_st, v_FPCR.v), f_gen_cvt_bits_uint(v_st, BigInt(3), f_gen_load(v_st, v_FPDecodeRounding35__4))))
    ...
    v_Exp44__3.v = f_gen_FPConvert(v_st, BigInt(32), BigInt(16), f_gen_slice(v_st, v_Vpart_read5__2.v, BigInt(48), BigInt(16)), f_gen_load(v_st, v_FPCR.v), f_gen_cvt_bits_uint(v_st, BigInt(3), f_gen_load(v_st, v_FPDecodeRounding42__4)))
    ...
    if (f_eq_bits(v_st, BigInt(1), mkBits(v_st, 1, BigInt("1", 2)), bvextract(v_st,v_enc,BigInt(22),BigInt(1)))) then {
      ...
      val v_temp16 : RTLabel = f_gen_branch(v_st, f_gen_eq_bits(v_st, BigInt(2), f_gen_slice(v_st, f_gen_load(v_st, v_FPCR.v), BigInt(22), BigInt(2)), f_gen_bit_lit(v_st, BigInt(2), mkBits(v_st, 2, BigInt("00", 2))))) 
      f_switch_context (v_st,f_true_branch(v_st, v_temp16))
      f_gen_store (v_st,v_FPDecodeRounding69__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("000", 2))))
      f_switch_context (v_st,f_false_branch(v_st, v_temp16))
      val v_temp17 : RTLabel = f_gen_branch(v_st, f_gen_eq_bits(v_st, BigInt(2), f_gen_slice(v_st, f_gen_load(v_st, v_FPCR.v), BigInt(22), BigInt(2)), f_gen_bit_lit(v_st, BigInt(2), mkBits(v_st, 2, BigInt("01", 2))))) 
      f_switch_context (v_st,f_true_branch(v_st, v_temp17))
      f_gen_store (v_st,v_FPDecodeRounding69__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("001", 2))))
      f_switch_context (v_st,f_false_branch(v_st, v_temp17))
      val v_temp18 : RTLabel = f_gen_branch(v_st, f_gen_eq_bits(v_st, BigInt(2), f_gen_slice(v_st, f_gen_load(v_st, v_FPCR.v), BigInt(22), BigInt(2)), f_gen_bit_lit(v_st, BigInt(2), mkBits(v_st, 2, BigInt("10", 2))))) 
      f_switch_context (v_st,f_true_branch(v_st, v_temp18))
      f_gen_store (v_st,v_FPDecodeRounding69__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("010", 2))))
      f_switch_context (v_st,f_false_branch(v_st, v_temp18))
      val v_temp19 : RTLabel = f_gen_branch(v_st, f_gen_eq_bits(v_st, BigInt(2), f_gen_slice(v_st, f_gen_load(v_st, v_FPCR.v), BigInt(22), BigInt(2)), f_gen_bit_lit(v_st, BigInt(2), mkBits(v_st, 2, BigInt("11", 2))))) 
      f_switch_context (v_st,f_true_branch(v_st, v_temp19))
      f_gen_store (v_st,v_FPDecodeRounding69__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("011", 2))))
      f_switch_context (v_st,f_false_branch(v_st, v_temp19))
      f_gen_assert (v_st,f_gen_bool_lit(v_st, false))
      f_switch_context (v_st,f_merge_branch(v_st, v_temp16))
      val v_Exp71__3 : RTSym = f_decl_bv(v_st, "Exp71__3", BigInt(64)) 
      f_gen_store (v_st,v_Exp71__3,f_gen_FPConvert(v_st, BigInt(64), BigInt(32), f_gen_slice(v_st, v_Vpart_read53__2.v, BigInt(0), BigInt(32)), f_gen_load(v_st, v_FPCR.v), f_gen_cvt_bits_uint(v_st, BigInt(3), f_gen_load(v_st, v_FPDecodeRounding69__4))))
      val v_FPDecodeRounding76__4 : RTSym = f_decl_bv(v_st, "FPDecodeRounding76__4", BigInt(3)) 
      val v_temp20 : RTLabel = f_gen_branch(v_st, f_gen_eq_bits(v_st, BigInt(2), f_gen_slice(v_st, f_gen_load(v_st, v_FPCR.v), BigInt(22), BigInt(2)), f_gen_bit_lit(v_st, BigInt(2), mkBits(v_st, 2, BigInt("00", 2))))) 
      f_switch_context (v_st,f_true_branch(v_st, v_temp20))
      f_gen_store (v_st,v_FPDecodeRounding76__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("000", 2))))
      f_switch_context (v_st,f_false_branch(v_st, v_temp20))
      val v_temp21 : RTLabel = f_gen_branch(v_st, f_gen_eq_bits(v_st, BigInt(2), f_gen_slice(v_st, f_gen_load(v_st, v_FPCR.v), BigInt(22), BigInt(2)), f_gen_bit_lit(v_st, BigInt(2), mkBits(v_st, 2, BigInt("01", 2))))) 
      f_switch_context (v_st,f_true_branch(v_st, v_temp21))
      f_gen_store (v_st,v_FPDecodeRounding76__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("001", 2))))
      f_switch_context (v_st,f_false_branch(v_st, v_temp21))
      val v_temp22 : RTLabel = f_gen_branch(v_st, f_gen_eq_bits(v_st, BigInt(2), f_gen_slice(v_st, f_gen_load(v_st, v_FPCR.v), BigInt(22), BigInt(2)), f_gen_bit_lit(v_st, BigInt(2), mkBits(v_st, 2, BigInt("10", 2))))) 
      f_switch_context (v_st,f_true_branch(v_st, v_temp22))
      f_gen_store (v_st,v_FPDecodeRounding76__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("010", 2))))
      f_switch_context (v_st,f_false_branch(v_st, v_temp22))
      val v_temp23 : RTLabel = f_gen_branch(v_st, f_gen_eq_bits(v_st, BigInt(2), f_gen_slice(v_st, f_gen_load(v_st, v_FPCR.v), BigInt(22), BigInt(2)), f_gen_bit_lit(v_st, BigInt(2), mkBits(v_st, 2, BigInt("11", 2))))) 
      f_switch_context (v_st,f_true_branch(v_st, v_temp23))
      f_gen_store (v_st,v_FPDecodeRounding76__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("011", 2))))
      f_switch_context (v_st,f_false_branch(v_st, v_temp23))
      f_gen_assert (v_st,f_gen_bool_lit(v_st, false))
      f_switch_context (v_st,f_merge_branch(v_st, v_temp20))
      val v_Exp78__3 = Mutable[Expr](rTExprDefault)
      v_Exp78__3.v = f_gen_FPConvert(v_st, BigInt(64), BigInt(32), f_gen_slice(v_st, v_Vpart_read53__2.v, BigInt(32), BigInt(32)), f_gen_load(v_st, v_FPCR.v), f_gen_cvt_bits_uint(v_st, BigInt(3), f_gen_load(v_st, v_FPDecodeRounding76__4)))
      assert (((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2))))))
