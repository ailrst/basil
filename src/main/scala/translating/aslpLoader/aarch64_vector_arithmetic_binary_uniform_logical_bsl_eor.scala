...
def f_aarch64_vector_arithmetic_binary_uniform_logical_bsl_eor (v_st: LiftState,v_enc: BV) : Unit = {
  if (f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(30),BigInt(1)), mkBits(v_st, 1, BigInt("1", 2)))) then {
    ...
    if (f_eq_bits(v_st, BigInt(2), bvextract(v_st,v_enc,BigInt(22),BigInt(2)), mkBits(v_st, 2, BigInt("00", 2)))) then {
      v_op__1.v = mkBits(v_st, 2, BigInt("11", 2))
    } else {
      if (f_eq_bits(v_st, BigInt(2), bvextract(v_st,v_enc,BigInt(22),BigInt(2)), mkBits(v_st, 2, BigInt("01", 2)))) then {
        v_op__1.v = mkBits(v_st, 2, BigInt("10", 2))
      } else {
        if (f_eq_bits(v_st, BigInt(2), bvextract(v_st,v_enc,BigInt(22),BigInt(2)), mkBits(v_st, 2, BigInt("10", 2)))) then {
    ...
    if (f_eq_bits(v_st, BigInt(2), v_op__1.v, mkBits(v_st, 2, BigInt("11", 2)))) then {
