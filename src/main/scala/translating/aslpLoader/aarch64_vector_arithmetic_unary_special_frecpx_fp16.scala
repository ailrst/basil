...
def f_aarch64_vector_arithmetic_unary_special_frecpx_fp16 (v_st: LiftState,v_enc: BitVecLiteral) : Unit = {
  ...
  f_gen_store (v_st,v_Exp10__2,f_gen_FPRecpX(v_st, BigInt(16), f_gen_slice(v_st, f_gen_array_load(v_st, v__Z.v, f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(5),BigInt(5)))), BigInt(0), BigInt(16)), f_gen_load(v_st, v_FPCR.v)))
