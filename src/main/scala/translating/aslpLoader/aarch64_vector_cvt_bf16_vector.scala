...
def f_aarch64_vector_cvt_bf16_vector (v_st: LiftState,v_enc: BV) : Unit = {
  ...
  f_gen_store (v_st,v_FPDecodeRounding14__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("000", 2))))
  ...
  f_gen_store (v_st,v_FPDecodeRounding14__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("001", 2))))
  ...
  f_gen_store (v_st,v_FPDecodeRounding14__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("010", 2))))
  ...
  f_gen_store (v_st,v_FPDecodeRounding14__4,f_gen_bit_lit(v_st, BigInt(3), mkBits(v_st, 3, BigInt("011", 2))))
  f_switch_context (v_st,f_false_branch(v_st, v_temp3))
  f_gen_assert (v_st,f_gen_bool_lit(v_st, false))
  f_switch_context (v_st,f_merge_branch(v_st, v_temp0))
  val v_Exp16__3 : RTSym = f_decl_bv(v_st, "Exp16__3", BigInt(16)) 
  f_gen_store (v_st,v_Exp16__3,f_gen_FPConvertBF(v_st, f_gen_slice(v_st, v_Exp8__2.v, BigInt(0), BigInt(32)), f_gen_load(v_st, v_FPCR.v), f_gen_cvt_bits_uint(v_st, BigInt(3), f_gen_load(v_st, v_FPDecodeRounding14__4))))
  ...
  f_gen_store (v_st,v_Exp23__3,f_gen_FPConvertBF(v_st, f_gen_slice(v_st, v_Exp8__2.v, BigInt(32), BigInt(32)), f_gen_load(v_st, v_FPCR.v), f_gen_cvt_bits_uint(v_st, BigInt(3), f_gen_load(v_st, v_FPDecodeRounding21__4))))
  ...
  f_gen_store (v_st,v_Exp30__3,f_gen_FPConvertBF(v_st, f_gen_slice(v_st, v_Exp8__2.v, BigInt(64), BigInt(32)), f_gen_load(v_st, v_FPCR.v), f_gen_cvt_bits_uint(v_st, BigInt(3), f_gen_load(v_st, v_FPDecodeRounding28__4))))
  ...
  v_Exp37__3.v = f_gen_FPConvertBF(v_st, f_gen_slice(v_st, v_Exp8__2.v, BigInt(96), BigInt(32)), f_gen_load(v_st, v_FPCR.v), f_gen_cvt_bits_uint(v_st, BigInt(3), f_gen_load(v_st, v_FPDecodeRounding35__4)))
