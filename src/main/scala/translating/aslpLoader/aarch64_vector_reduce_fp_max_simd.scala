...
def f_aarch64_vector_reduce_fp_max_simd (v_st: LiftState,v_enc: BV,v_pc: BV) : Unit = {
  if ( (!(f_eq_bits(v_st, BigInt(32), f_and_bits(v_st, BigInt(32), v_enc, mkBits(v_st, 32, BigInt("01000000010000000000000000000000", 2))), mkBits(v_st, 32, BigInt("01000000000000000000000000000000", 2)))))) then {
    ...
    if (f_eq_bits(v_st, BigInt(32), f_and_bits(v_st, BigInt(32), v_enc, mkBits(v_st, 32, BigInt("00000000100000000000000000000000", 2))), mkBits(v_st, 32, BigInt("00000000100000000000000000000000", 2)))) then {
      ...
      f_gen_store (v_st,v_Exp31__4,f_gen_FPMin(v_st, BigInt(32), f_gen_slice(v_st, v_Exp7__2.v, BigInt(0), BigInt(32)), f_gen_slice(v_st, v_Exp7__2.v, BigInt(32), BigInt(32)), f_gen_load(v_st, v_FPCR.v)))
      v_result__3_1.v = f_gen_load(v_st, v_Exp31__4)
    } else {
      val v_Exp33__4 : RTSym = f_decl_bv(v_st, "Exp33__4", BigInt(32)) 
      f_gen_store (v_st,v_Exp33__4,f_gen_FPMax(v_st, BigInt(32), f_gen_slice(v_st, v_Exp7__2.v, BigInt(0), BigInt(32)), f_gen_slice(v_st, v_Exp7__2.v, BigInt(32), BigInt(32)), f_gen_load(v_st, v_FPCR.v)))
      v_result__3_1.v = f_gen_load(v_st, v_Exp33__4)
    }
    if (f_eq_bits(v_st, BigInt(32), f_and_bits(v_st, BigInt(32), v_enc, mkBits(v_st, 32, BigInt("00000000100000000000000000000000", 2))), mkBits(v_st, 32, BigInt("00000000100000000000000000000000", 2)))) then {
      val v_Exp42__3 = Mutable[Expr](rTExprDefault)
      v_Exp42__3.v = f_gen_FPMin(v_st, BigInt(32), v_result__3_1.v, v_Exp22__3.v, f_gen_load(v_st, v_FPCR.v))
      v_result__2.v = v_Exp42__3.v
    } else {
      val v_Exp44__3 = Mutable[Expr](rTExprDefault)
      v_Exp44__3.v = f_gen_FPMax(v_st, BigInt(32), v_result__3_1.v, v_Exp22__3.v, f_gen_load(v_st, v_FPCR.v))
