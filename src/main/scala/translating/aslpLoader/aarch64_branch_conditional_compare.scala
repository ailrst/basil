...
def f_aarch64_branch_conditional_compare (v_st: LiftState,v_enc: BV,v_pc: BV) : Unit = {
  if (f_eq_bits(v_st, BigInt(32), f_and_bits(v_st, BigInt(32), v_enc, mkBits(v_st, 32, BigInt("10000000000000000000000000000000", 2))), mkBits(v_st, 32, BigInt("10000000000000000000000000000000", 2)))) then {
    ...
    val v_temp1 : RTLabel = f_gen_branch(v_st, f_gen_eq_enum(v_st, f_gen_eq_bits(v_st, BigInt(32), v_X_read15__2.v, f_gen_bit_lit(v_st, BigInt(32), mkBits(v_st, 32, BigInt("00000000000000000000000000000000", 2)))), f_gen_bool_lit(v_st, f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(24),BigInt(1)), mkBits(v_st, 1, BigInt("0", 2)))))) 
