  ...
  if (f_eq_bits(v_st, BigInt(2), f_append_bits(v_st, BigInt(1), BigInt(1), bvextract(v_st,v_enc,BigInt(22),BigInt(1)), bvextract(v_st,v_enc,BigInt(30),BigInt(1))), mkBits(v_st, 2, BigInt("10", 2)))) then {
    ...
    if (f_eq_bits(v_st, BigInt(1), mkBits(v_st, 1, BigInt("0", 2)), bvextract(v_st,v_enc,BigInt(22),BigInt(1)))) then {
      if (f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(30),BigInt(1)), mkBits(v_st, 1, BigInt("1", 2)))) then {
        ...
        if (f_eq_bits(v_st, BigInt(2), f_append_bits(v_st, BigInt(1), BigInt(1), bvextract(v_st,v_enc,BigInt(12),BigInt(1)), bvextract(v_st,v_enc,BigInt(23),BigInt(1))), mkBits(v_st, 2, BigInt("00", 2)))) then {
          v_FPDecodeRounding28__2.v = mkBits(v_st, 3, BigInt("000", 2))
        } else {
          if (f_eq_bits(v_st, BigInt(2), f_append_bits(v_st, BigInt(1), BigInt(1), bvextract(v_st,v_enc,BigInt(12),BigInt(1)), bvextract(v_st,v_enc,BigInt(23),BigInt(1))), mkBits(v_st, 2, BigInt("01", 2)))) then {
            v_FPDecodeRounding28__2.v = mkBits(v_st, 3, BigInt("001", 2))
          } else {
            if (f_eq_bits(v_st, BigInt(2), f_append_bits(v_st, BigInt(1), BigInt(1), bvextract(v_st,v_enc,BigInt(12),BigInt(1)), bvextract(v_st,v_enc,BigInt(23),BigInt(1))), mkBits(v_st, 2, BigInt("10", 2)))) then {
              v_FPDecodeRounding28__2.v = mkBits(v_st, 3, BigInt("010", 2))
            } else {
              if (f_eq_bits(v_st, BigInt(2), f_append_bits(v_st, BigInt(1), BigInt(1), bvextract(v_st,v_enc,BigInt(12),BigInt(1)), bvextract(v_st,v_enc,BigInt(23),BigInt(1))), mkBits(v_st, 2, BigInt("11", 2)))) then {
                v_FPDecodeRounding28__2.v = mkBits(v_st, 3, BigInt("011", 2))
              } else {
                throw Exception("not supported")
              }
            }
      ...
      if (f_eq_bits(v_st, BigInt(1), mkBits(v_st, 1, BigInt("1", 2)), bvextract(v_st,v_enc,BigInt(22),BigInt(1)))) then {
        if (f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(30),BigInt(1)), mkBits(v_st, 1, BigInt("1", 2)))) then {
          ...
          if (f_eq_bits(v_st, BigInt(2), f_append_bits(v_st, BigInt(1), BigInt(1), bvextract(v_st,v_enc,BigInt(12),BigInt(1)), bvextract(v_st,v_enc,BigInt(23),BigInt(1))), mkBits(v_st, 2, BigInt("00", 2)))) then {
            v_FPDecodeRounding47__2.v = mkBits(v_st, 3, BigInt("000", 2))
          } else {
            if (f_eq_bits(v_st, BigInt(2), f_append_bits(v_st, BigInt(1), BigInt(1), bvextract(v_st,v_enc,BigInt(12),BigInt(1)), bvextract(v_st,v_enc,BigInt(23),BigInt(1))), mkBits(v_st, 2, BigInt("01", 2)))) then {
              v_FPDecodeRounding47__2.v = mkBits(v_st, 3, BigInt("001", 2))
            } else {
              if (f_eq_bits(v_st, BigInt(2), f_append_bits(v_st, BigInt(1), BigInt(1), bvextract(v_st,v_enc,BigInt(12),BigInt(1)), bvextract(v_st,v_enc,BigInt(23),BigInt(1))), mkBits(v_st, 2, BigInt("10", 2)))) then {
                v_FPDecodeRounding47__2.v = mkBits(v_st, 3, BigInt("010", 2))
              } else {
                if (f_eq_bits(v_st, BigInt(2), f_append_bits(v_st, BigInt(1), BigInt(1), bvextract(v_st,v_enc,BigInt(12),BigInt(1)), bvextract(v_st,v_enc,BigInt(23),BigInt(1))), mkBits(v_st, 2, BigInt("11", 2)))) then {
                  v_FPDecodeRounding47__2.v = mkBits(v_st, 3, BigInt("011", 2))
                } else {
                  throw Exception("not supported")
                }
              }
          ...
          if (f_eq_bits(v_st, BigInt(2), f_append_bits(v_st, BigInt(1), BigInt(1), bvextract(v_st,v_enc,BigInt(12),BigInt(1)), bvextract(v_st,v_enc,BigInt(23),BigInt(1))), mkBits(v_st, 2, BigInt("00", 2)))) then {
            v_FPDecodeRounding65__2.v = mkBits(v_st, 3, BigInt("000", 2))
          } else {
            if (f_eq_bits(v_st, BigInt(2), f_append_bits(v_st, BigInt(1), BigInt(1), bvextract(v_st,v_enc,BigInt(12),BigInt(1)), bvextract(v_st,v_enc,BigInt(23),BigInt(1))), mkBits(v_st, 2, BigInt("01", 2)))) then {
              v_FPDecodeRounding65__2.v = mkBits(v_st, 3, BigInt("001", 2))
            } else {
              if (f_eq_bits(v_st, BigInt(2), f_append_bits(v_st, BigInt(1), BigInt(1), bvextract(v_st,v_enc,BigInt(12),BigInt(1)), bvextract(v_st,v_enc,BigInt(23),BigInt(1))), mkBits(v_st, 2, BigInt("10", 2)))) then {
                v_FPDecodeRounding65__2.v = mkBits(v_st, 3, BigInt("010", 2))
              } else {
                if (f_eq_bits(v_st, BigInt(2), f_append_bits(v_st, BigInt(1), BigInt(1), bvextract(v_st,v_enc,BigInt(12),BigInt(1)), bvextract(v_st,v_enc,BigInt(23),BigInt(1))), mkBits(v_st, 2, BigInt("11", 2)))) then {
                  v_FPDecodeRounding65__2.v = mkBits(v_st, 3, BigInt("011", 2))
                } else {
                  throw Exception("not supported")
                }
              }
