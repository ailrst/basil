...
def f_aarch64_integer_pac_autia_hint (v_st: LiftState,v_enc: BitVecLiteral) : Unit = {
  ...
  if (f_eq_bits(v_st, BigInt(7), f_append_bits(v_st, BigInt(4), BigInt(3), bvextract(v_st,v_enc,BigInt(8),BigInt(4)), bvextract(v_st,v_enc,BigInt(5),BigInt(3))), BitVecLiteral(BigInt("0011100", 2), 7))) then {
    v_d__1.v = BitVecLiteral(BigInt("11110", 2), 5)
    v_n__1.v = BitVecLiteral(BigInt("11111", 2), 5)
  } else {
    if (f_eq_bits(v_st, BigInt(7), f_append_bits(v_st, BigInt(4), BigInt(3), bvextract(v_st,v_enc,BigInt(8),BigInt(4)), bvextract(v_st,v_enc,BigInt(5),BigInt(3))), BitVecLiteral(BigInt("0011101", 2), 7))) then {
      v_d__1.v = BitVecLiteral(BigInt("11110", 2), 5)
      v_source_is_sp__1.v = true
    } else {
      if (f_eq_bits(v_st, BigInt(7), f_append_bits(v_st, BigInt(4), BigInt(3), bvextract(v_st,v_enc,BigInt(8),BigInt(4)), bvextract(v_st,v_enc,BigInt(5),BigInt(3))), BitVecLiteral(BigInt("0001100", 2), 7))) then {
