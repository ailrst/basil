...
def f_aarch64_float_move_fp_imm (v_st: LiftState,v_enc: BitVecLiteral) : Unit = {
  val v_Exp2__1 : Boolean = f_eq_bits(v_st, BigInt(2), bvextract(v_st,v_enc,BigInt(22),BigInt(2)), BitVecLiteral(BigInt("11", 2), 2)) 
  if (v_Exp2__1) then {
