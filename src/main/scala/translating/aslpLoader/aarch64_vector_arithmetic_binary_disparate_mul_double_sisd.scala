...
def f_aarch64_vector_arithmetic_binary_disparate_mul_double_sisd (v_st: LiftState,v_enc: BV) : Unit = {
  if (v_split_expr_43155(v_st, v_enc)) then {
    ...
    if (v_split_expr_43156(v_st, v_enc)) then {
      v_split_fun_43206 (v_st,v_enc)
    } else {
      v_split_fun_43207 (v_st,v_enc)
    }
  }
}
...
def v_split_expr_43164 (v_st: LiftState)  = {
...
def v_split_expr_43167 (v_st: LiftState,v_SignedSatQ20__2: RTSym)  = {
...
def v_split_expr_43173 (v_st: LiftState,v_enc: BV)  = {
...
def v_split_expr_43174 (v_st: LiftState,v_enc: BV)  = {
...
def v_split_expr_43176 (v_st: LiftState)  = {
  f_gen_append_bits(v_st, BigInt(4), BigInt(28), f_gen_slice(v_st, f_gen_load(v_st, v_FPSR.v), BigInt(28), BigInt(4)), f_gen_append_bits(v_st, BigInt(1), BigInt(27), f_gen_bit_lit(v_st, BigInt(1), mkBits(v_st, 1, BigInt("1", 2))), f_gen_slice(v_st, f_gen_load(v_st, v_FPSR.v), BigInt(0), BigInt(27))))
}
def v_split_expr_43177 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
def v_split_expr_43178 (v_st: LiftState,v_enc: BV)  = {
  f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(0),BigInt(5)))
}
def v_split_expr_43179 (v_st: LiftState,v_SignedSatQ51__2: RTSym)  = {
  f_gen_ZeroExtend(v_st, BigInt(32), BigInt(128), f_gen_load(v_st, v_SignedSatQ51__2), f_gen_int_lit(v_st, BigInt(128)))
}
def v_split_expr_43180 (v_st: LiftState,v_enc: BV)  = {
  f_eq_bits(v_st, BigInt(2), mkBits(v_st, 2, BigInt("10", 2)), bvextract(v_st,v_enc,BigInt(22),BigInt(2)))
}
def v_split_expr_43181 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(5),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(5),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
def v_split_expr_43182 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(5),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(5),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
def v_split_expr_43183 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(16),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(16),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
def v_split_expr_43184 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(16),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(16),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
def v_split_expr_43185 (v_st: LiftState,v_enc: BV)  = {
...
def v_split_expr_43186 (v_st: LiftState,v_enc: BV)  = {
...
def v_split_expr_43187 (v_st: LiftState,v_enc: BV)  = {
...
def v_split_expr_43188 (v_st: LiftState)  = {
  f_gen_append_bits(v_st, BigInt(4), BigInt(28), f_gen_slice(v_st, f_gen_load(v_st, v_FPSR.v), BigInt(28), BigInt(4)), f_gen_append_bits(v_st, BigInt(1), BigInt(27), f_gen_bit_lit(v_st, BigInt(1), mkBits(v_st, 1, BigInt("1", 2))), f_gen_slice(v_st, f_gen_load(v_st, v_FPSR.v), BigInt(0), BigInt(27))))
}
def v_split_expr_43189 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
def v_split_expr_43190 (v_st: LiftState,v_enc: BV)  = {
  f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(0),BigInt(5)))
}
def v_split_expr_43191 (v_st: LiftState,v_SignedSatQ82__2: RTSym)  = {
  f_gen_ZeroExtend(v_st, BigInt(64), BigInt(128), f_gen_load(v_st, v_SignedSatQ82__2), f_gen_int_lit(v_st, BigInt(128)))
}
def v_split_expr_43192 (v_st: LiftState,v_enc: BV)  = {
...
def v_split_expr_43195 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(16),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(16),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
def v_split_expr_43196 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(16),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(16),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
def v_split_expr_43197 (v_st: LiftState,v_enc: BV)  = {
...
def v_split_expr_43198 (v_st: LiftState,v_enc: BV)  = {
...
def v_split_expr_43199 (v_st: LiftState,v_enc: BV)  = {
...
def v_split_expr_43200 (v_st: LiftState)  = {
  f_gen_append_bits(v_st, BigInt(4), BigInt(28), f_gen_slice(v_st, f_gen_load(v_st, v_FPSR.v), BigInt(28), BigInt(4)), f_gen_append_bits(v_st, BigInt(1), BigInt(27), f_gen_bit_lit(v_st, BigInt(1), mkBits(v_st, 1, BigInt("1", 2))), f_gen_slice(v_st, f_gen_load(v_st, v_FPSR.v), BigInt(0), BigInt(27))))
}
def v_split_expr_43201 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
def v_split_expr_43202 (v_st: LiftState,v_enc: BV)  = {
  f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(0),BigInt(5)))
}
def v_split_fun_43203 (v_st: LiftState,v_enc: BV) : Unit = {
  assert (v_split_expr_43193(v_st, v_enc))
  assert (v_split_expr_43194(v_st, v_enc))
  assert (v_split_expr_43195(v_st, v_enc))
  assert (v_split_expr_43196(v_st, v_enc))
  ...
  val v_temp9 : RTLabel = v_split_expr_43197(v_st, v_enc) 
  ...
  val v_temp10 : RTLabel = v_split_expr_43198(v_st, v_enc) 
  ...
  f_gen_store (v_st,v_SignedSatQ113__2,v_split_expr_43199(v_st, v_enc))
  ...
  f_gen_store (v_st,v_FPSR.v,v_split_expr_43200(v_st))
  f_switch_context (v_st,f_merge_branch(v_st, v_temp11))
  assert (v_split_expr_43201(v_st, v_enc))
  f_gen_array_store (v_st,v__Z.v,v_split_expr_43202(v_st, v_enc),f_gen_load(v_st, v_SignedSatQ113__2))
}
def v_split_fun_43204 (v_st: LiftState,v_enc: BV) : Unit = {
  assert (v_split_expr_43181(v_st, v_enc))
  assert (v_split_expr_43182(v_st, v_enc))
  assert (v_split_expr_43183(v_st, v_enc))
  assert (v_split_expr_43184(v_st, v_enc))
  ...
  val v_temp6 : RTLabel = v_split_expr_43185(v_st, v_enc) 
  ...
  val v_temp7 : RTLabel = v_split_expr_43186(v_st, v_enc) 
  ...
  f_gen_store (v_st,v_SignedSatQ82__2,v_split_expr_43187(v_st, v_enc))
  ...
  f_gen_store (v_st,v_FPSR.v,v_split_expr_43188(v_st))
  f_switch_context (v_st,f_merge_branch(v_st, v_temp8))
  assert (v_split_expr_43189(v_st, v_enc))
  f_gen_array_store (v_st,v__Z.v,v_split_expr_43190(v_st, v_enc),v_split_expr_43191(v_st, v_SignedSatQ82__2))
}
def v_split_fun_43205 (v_st: LiftState,v_enc: BV) : Unit = {
  assert (v_split_expr_43169(v_st, v_enc))
  assert (v_split_expr_43170(v_st, v_enc))
  assert (v_split_expr_43171(v_st, v_enc))
  assert (v_split_expr_43172(v_st, v_enc))
  ...
  val v_temp3 : RTLabel = v_split_expr_43173(v_st, v_enc) 
  ...
  val v_temp4 : RTLabel = v_split_expr_43174(v_st, v_enc) 
  ...
  f_gen_store (v_st,v_SignedSatQ51__2,v_split_expr_43175(v_st, v_enc))
  ...
  f_gen_store (v_st,v_FPSR.v,v_split_expr_43176(v_st))
  f_switch_context (v_st,f_merge_branch(v_st, v_temp5))
  assert (v_split_expr_43177(v_st, v_enc))
  f_gen_array_store (v_st,v__Z.v,v_split_expr_43178(v_st, v_enc),v_split_expr_43179(v_st, v_SignedSatQ51__2))
}
def v_split_fun_43206 (v_st: LiftState,v_enc: BV) : Unit = {
  assert (v_split_expr_43157(v_st, v_enc))
  assert (v_split_expr_43158(v_st, v_enc))
  assert (v_split_expr_43159(v_st, v_enc))
  assert (v_split_expr_43160(v_st, v_enc))
  ...
  val v_temp0 : RTLabel = v_split_expr_43161(v_st, v_enc) 
  ...
  val v_temp1 : RTLabel = v_split_expr_43162(v_st, v_enc) 
  ...
  f_gen_store (v_st,v_SignedSatQ20__2,v_split_expr_43163(v_st, v_enc))
  ...
  f_gen_store (v_st,v_FPSR.v,v_split_expr_43164(v_st))
  f_switch_context (v_st,f_merge_branch(v_st, v_temp2))
  assert (v_split_expr_43165(v_st, v_enc))
  f_gen_array_store (v_st,v__Z.v,v_split_expr_43166(v_st, v_enc),v_split_expr_43167(v_st, v_SignedSatQ20__2))
}
def v_split_fun_43207 (v_st: LiftState,v_enc: BV) : Unit = {
  if (v_split_expr_43168(v_st, v_enc)) then {
    v_split_fun_43205 (v_st,v_enc)
  } else {
    if (v_split_expr_43180(v_st, v_enc)) then {
      v_split_fun_43204 (v_st,v_enc)
    } else {
      if (v_split_expr_43192(v_st, v_enc)) then {
        v_split_fun_43203 (v_st,v_enc)
      } else {
        throw Exception("not supported")
      }
    }
