...
def f_aarch64_vector_arithmetic_unary_fp16_conv_float_bulk_sisd (v_st: LiftState,v_enc: BV) : Unit = {
  ...
  f_gen_array_store (v_st,v__Z.v,f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(0),BigInt(5))),f_gen_ZeroExtend(v_st, BigInt(16), BigInt(128), v_Exp12__2.v, f_gen_int_lit(v_st, BigInt(128))))
}
