...
def f_aarch64_vector_cvt_bf16_scalar (v_st: LiftState,v_enc: BV) : Unit = {
  ...
  v_Exp13__3.v = f_gen_FPConvertBF(v_st, f_gen_slice(v_st, v_Exp7__2.v, BigInt(0), BigInt(32)), f_gen_load(v_st, v_FPCR.v), f_gen_cvt_bits_uint(v_st, BigInt(3), f_gen_load(v_st, v_FPDecodeRounding11__4)))
