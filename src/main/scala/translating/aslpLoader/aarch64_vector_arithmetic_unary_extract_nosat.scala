...
def f_aarch64_vector_arithmetic_unary_extract_nosat (v_st: LiftState,v_enc: BV) : Unit = {
  if (v_split_expr_77417(v_st, v_enc)) then {
    ...
    if (v_split_expr_77418(v_st, v_enc)) then {
      v_split_fun_77469 (v_st,v_enc)
    } else {
      v_split_fun_77470 (v_st,v_enc)
    }
  }
}
def v_split_expr_77417 (v_st: LiftState,v_enc: BV)  = {
...
def v_split_expr_77421 (v_st: LiftState,v_enc: BV)  = {
...
def v_split_expr_77422 (v_st: LiftState,v_enc: BV)  = {
  f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(30),BigInt(1)), mkBits(v_st, 1, BigInt("0", 2)))
}
def v_split_expr_77423 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
...
def v_split_expr_77430 (v_st: LiftState,v_enc: BV)  = {
  f_eq_bits(v_st, BigInt(2), mkBits(v_st, 2, BigInt("01", 2)), bvextract(v_st,v_enc,BigInt(22),BigInt(2)))
}
def v_split_expr_77431 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(5),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(5),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
def v_split_expr_77432 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
def v_split_expr_77433 (v_st: LiftState,v_enc: BV)  = {
  ((f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(30),BigInt(1)), mkBits(v_st, 1, BigInt("0", 2)))) || ((( (!(f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(30),BigInt(1)), mkBits(v_st, 1, BigInt("0", 2)))))) && (f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(30),BigInt(1)), mkBits(v_st, 1, BigInt("1", 2)))))))
}
def v_split_expr_77434 (v_st: LiftState,v_enc: BV)  = {
  f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(30),BigInt(1)), mkBits(v_st, 1, BigInt("0", 2)))
}
def v_split_expr_77435 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
def v_split_expr_77436 (v_st: LiftState,v_enc: BV)  = {
  f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(0),BigInt(5)))
}
def v_split_expr_77437 (v_st: LiftState,v_enc: BV)  = {
...
def v_split_expr_77438 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
def v_split_expr_77439 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
...
def v_split_expr_77445 (v_st: LiftState,v_enc: BV)  = {
  ((f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(30),BigInt(1)), mkBits(v_st, 1, BigInt("0", 2)))) || ((( (!(f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(30),BigInt(1)), mkBits(v_st, 1, BigInt("0", 2)))))) && (f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(30),BigInt(1)), mkBits(v_st, 1, BigInt("1", 2)))))))
}
...
def v_split_expr_77449 (v_st: LiftState,v_enc: BV)  = {
...
def v_split_expr_77450 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
def v_split_expr_77451 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
...
def v_split_expr_77458 (v_st: LiftState,v_enc: BV)  = {
  f_eq_bits(v_st, BigInt(1), bvextract(v_st,v_enc,BigInt(30),BigInt(1)), mkBits(v_st, 1, BigInt("0", 2)))
}
def v_split_expr_77459 (v_st: LiftState,v_enc: BV)  = {
  ((f_sle_bits(v_st, BigInt(6), mkBits(v_st, 6, BigInt("000000", 2)), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)))) && (f_sle_bits(v_st, BigInt(6), f_ZeroExtend(v_st, BigInt(5), BigInt(6), bvextract(v_st,v_enc,BigInt(0),BigInt(5)), BigInt(6)), mkBits(v_st, 6, BigInt("011111", 2)))))
}
def v_split_expr_77460 (v_st: LiftState,v_enc: BV)  = {
  f_cvt_bits_uint(v_st, BigInt(5), bvextract(v_st,v_enc,BigInt(0),BigInt(5)))
}
def v_split_expr_77461 (v_st: LiftState,v_enc: BV)  = {
...
def v_split_fun_77466 (v_st: LiftState,v_enc: BV) : Unit = {
  assert (v_split_expr_77455(v_st, v_enc))
  assert (v_split_expr_77456(v_st, v_enc))
  val v_Exp107__2 : Boolean = v_split_expr_77457(v_st, v_enc) 
  assert (v_Exp107__2)
  if (v_split_expr_77458(v_st, v_enc)) then {
    assert (v_split_expr_77459(v_st, v_enc))
    f_gen_array_store (v_st,v__Z.v,v_split_expr_77460(v_st, v_enc),v_split_expr_77461(v_st, v_enc))
  } else {
    assert (v_split_expr_77462(v_st, v_enc))
    assert (v_split_expr_77463(v_st, v_enc))
    f_gen_array_store (v_st,v__Z.v,v_split_expr_77464(v_st, v_enc),v_split_expr_77465(v_st, v_enc))
  }
}
def v_split_fun_77467 (v_st: LiftState,v_enc: BV) : Unit = {
  assert (v_split_expr_77443(v_st, v_enc))
  assert (v_split_expr_77444(v_st, v_enc))
  val v_Exp83__2 : Boolean = v_split_expr_77445(v_st, v_enc) 
  assert (v_Exp83__2)
  if (v_split_expr_77446(v_st, v_enc)) then {
    assert (v_split_expr_77447(v_st, v_enc))
    f_gen_array_store (v_st,v__Z.v,v_split_expr_77448(v_st, v_enc),v_split_expr_77449(v_st, v_enc))
  } else {
    assert (v_split_expr_77450(v_st, v_enc))
    assert (v_split_expr_77451(v_st, v_enc))
    f_gen_array_store (v_st,v__Z.v,v_split_expr_77452(v_st, v_enc),v_split_expr_77453(v_st, v_enc))
  }
}
def v_split_fun_77468 (v_st: LiftState,v_enc: BV) : Unit = {
  assert (v_split_expr_77431(v_st, v_enc))
  assert (v_split_expr_77432(v_st, v_enc))
  val v_Exp57__2 : Boolean = v_split_expr_77433(v_st, v_enc) 
  assert (v_Exp57__2)
  if (v_split_expr_77434(v_st, v_enc)) then {
    assert (v_split_expr_77435(v_st, v_enc))
    f_gen_array_store (v_st,v__Z.v,v_split_expr_77436(v_st, v_enc),v_split_expr_77437(v_st, v_enc))
  } else {
    assert (v_split_expr_77438(v_st, v_enc))
    assert (v_split_expr_77439(v_st, v_enc))
    f_gen_array_store (v_st,v__Z.v,v_split_expr_77440(v_st, v_enc),v_split_expr_77441(v_st, v_enc))
  }
}
def v_split_fun_77469 (v_st: LiftState,v_enc: BV) : Unit = {
  assert (v_split_expr_77419(v_st, v_enc))
  assert (v_split_expr_77420(v_st, v_enc))
  val v_Exp27__2 : Boolean = v_split_expr_77421(v_st, v_enc) 
  assert (v_Exp27__2)
  if (v_split_expr_77422(v_st, v_enc)) then {
    assert (v_split_expr_77423(v_st, v_enc))
    f_gen_array_store (v_st,v__Z.v,v_split_expr_77424(v_st, v_enc),v_split_expr_77425(v_st, v_enc))
  } else {
    assert (v_split_expr_77426(v_st, v_enc))
    assert (v_split_expr_77427(v_st, v_enc))
    f_gen_array_store (v_st,v__Z.v,v_split_expr_77428(v_st, v_enc),v_split_expr_77429(v_st, v_enc))
  }
}
def v_split_fun_77470 (v_st: LiftState,v_enc: BV) : Unit = {
  if (v_split_expr_77430(v_st, v_enc)) then {
    v_split_fun_77468 (v_st,v_enc)
  } else {
    if (v_split_expr_77442(v_st, v_enc)) then {
      v_split_fun_77467 (v_st,v_enc)
    } else {
      if (v_split_expr_77454(v_st, v_enc)) then {
        v_split_fun_77466 (v_st,v_enc)
      } else {
        throw Exception("not supported")
      }
    }
