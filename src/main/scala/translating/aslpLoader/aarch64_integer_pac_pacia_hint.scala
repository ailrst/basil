...
def f_aarch64_integer_pac_pacia_hint (v_st: LiftState,v_enc: BitVecLiteral) : Unit = {
  ...
  if (f_eq_bits(v_st, BigInt(7), f_append_bits(v_st, BigInt(4), BigInt(3), bvextract(v_st,v_enc,BigInt(8),BigInt(4)), bvextract(v_st,v_enc,BigInt(5),BigInt(3))), BitVecLiteral(BigInt("0011000", 2), 7))) then {
    v_d__1.v = BitVecLiteral(BigInt("11110", 2), 5)
    v_n__1.v = BitVecLiteral(BigInt("11111", 2), 5)
  } else {
    if (f_eq_bits(v_st, BigInt(7), f_append_bits(v_st, BigInt(4), BigInt(3), bvextract(v_st,v_enc,BigInt(8),BigInt(4)), bvextract(v_st,v_enc,BigInt(5),BigInt(3))), BitVecLiteral(BigInt("0011001", 2), 7))) then {
      v_d__1.v = BitVecLiteral(BigInt("11110", 2), 5)
      ...
      val (tmp4402,tmp4403,tmp4404) = f_gen_branch(v_st, f_gen_load(v_st, v_Exp6__2)) 
      v_temp0.v = tmp4402
      v_temp1.v = tmp4403
      v_temp2.v = tmp4404
      ...
      val (tmp4405,tmp4406,tmp4407) = f_gen_branch(v_st, f_gen_eq_bits(v_st, BigInt(2), f_gen_load(v_st, v_PSTATE_BTYPE.v), f_gen_bit_lit(v_st, BigInt(2), BitVecLiteral(BigInt("11", 2), 2)))) 
      v_temp3.v = tmp4405
      v_temp4.v = tmp4406
      v_temp5.v = tmp4407
      ...
      if (f_eq_bits(v_st, BigInt(7), f_append_bits(v_st, BigInt(4), BigInt(3), bvextract(v_st,v_enc,BigInt(8),BigInt(4)), bvextract(v_st,v_enc,BigInt(5),BigInt(3))), BitVecLiteral(BigInt("0001000", 2), 7))) then {
