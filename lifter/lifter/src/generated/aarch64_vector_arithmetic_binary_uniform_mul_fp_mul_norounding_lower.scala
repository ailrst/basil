...
def f_aarch64_vector_arithmetic_binary_uniform_mul_fp_mul_norounding_lower[RTSym, RTLabel, BV <: RTSym] (v_st: LiftState[RTSym, RTLabel, BV],v_enc: BV,v_pc: BV) : Unit = {
  if (v_st.f_eq_bits(BigInt(32), v_st.f_and_bits(BigInt(32), v_enc, v_st.mkBits(32, BigInt("01000000000000000000000000000000", 2))), v_st.mkBits(32, BigInt("01000000000000000000000000000000", 2)))) then {
    ...
    if (v_st.f_eq_bits(BigInt(32), v_st.f_and_bits(BigInt(32), v_enc, v_st.mkBits(32, BigInt("00000000100000000000000000000000", 2))), v_st.mkBits(32, BigInt("00000000100000000000000000000000", 2)))) then {
      ...
      v_st.f_gen_store (v_Exp39__2,v_st.f_gen_FPMulAddH(BigInt(32), v_st.f_gen_slice(v_st.f_gen_load(v_Exp19__2), BigInt(32), BigInt(32)), v_st.f_gen_append_bits(BigInt(1), BigInt(15), v_st.f_gen_not_bits(BigInt(1), v_st.f_gen_slice(v_st.f_gen_load(v_Exp11__3), BigInt(31), BigInt(1))), v_st.f_gen_slice(v_st.f_gen_load(v_Exp11__3), BigInt(16), BigInt(15))), v_st.f_gen_slice(v_st.f_gen_load(v_Exp16__3), BigInt(16), BigInt(16)), v_st.f_gen_load(v_st.v_FPCR.v)))
      ...
      v_st.f_gen_store (v_Exp44__2,v_st.f_gen_FPMulAddH(BigInt(32), v_st.f_gen_slice(v_st.f_gen_load(v_Exp19__2), BigInt(32), BigInt(32)), v_st.f_gen_slice(v_st.f_gen_load(v_Exp11__3), BigInt(16), BigInt(16)), v_st.f_gen_slice(v_st.f_gen_load(v_Exp16__3), BigInt(16), BigInt(16)), v_st.f_gen_load(v_st.v_FPCR.v)))
    ...
    if (v_st.f_eq_bits(BigInt(32), v_st.f_and_bits(BigInt(32), v_enc, v_st.mkBits(32, BigInt("00000000100000000000000000000000", 2))), v_st.mkBits(32, BigInt("00000000100000000000000000000000", 2)))) then {
      ...
      v_st.f_gen_store (v_Exp57__2,v_st.f_gen_FPMulAddH(BigInt(32), v_st.f_gen_slice(v_st.f_gen_load(v_Exp19__2), BigInt(64), BigInt(32)), v_st.f_gen_slice(v_st.f_gen_load(v_Exp11__3), BigInt(32), BigInt(16)), v_st.f_gen_slice(v_st.f_gen_load(v_Exp16__3), BigInt(32), BigInt(16)), v_st.f_gen_load(v_st.v_FPCR.v)))
    ...
    if (v_st.f_eq_bits(BigInt(32), v_st.f_and_bits(BigInt(32), v_enc, v_st.mkBits(32, BigInt("00000000100000000000000000000000", 2))), v_st.mkBits(32, BigInt("00000000100000000000000000000000", 2)))) then {
      ...
      v_st.f_gen_store (v_Exp65__2,v_st.f_gen_FPMulAddH(BigInt(32), v_st.f_gen_slice(v_st.f_gen_load(v_Exp19__2), BigInt(96), BigInt(32)), v_st.f_gen_append_bits(BigInt(1), BigInt(15), v_st.f_gen_not_bits(BigInt(1), v_st.f_gen_slice(v_st.f_gen_load(v_Exp11__3), BigInt(63), BigInt(1))), v_st.f_gen_slice(v_st.f_gen_load(v_Exp11__3), BigInt(48), BigInt(15))), v_st.f_gen_slice(v_st.f_gen_load(v_Exp16__3), BigInt(48), BigInt(16)), v_st.f_gen_load(v_st.v_FPCR.v)))
      ...
      v_st.f_gen_store (v_Exp70__2,v_st.f_gen_FPMulAddH(BigInt(32), v_st.f_gen_slice(v_st.f_gen_load(v_Exp19__2), BigInt(96), BigInt(32)), v_st.f_gen_slice(v_st.f_gen_load(v_Exp11__3), BigInt(48), BigInt(16)), v_st.f_gen_slice(v_st.f_gen_load(v_Exp16__3), BigInt(48), BigInt(16)), v_st.f_gen_load(v_st.v_FPCR.v)))
    ...
    if (v_st.f_eq_bits(BigInt(32), v_st.f_and_bits(BigInt(32), v_enc, v_st.mkBits(32, BigInt("00000000100000000000000000000000", 2))), v_st.mkBits(32, BigInt("00000000100000000000000000000000", 2)))) then {
      ...
      v_st.f_gen_store (v_Exp110__2,v_st.f_gen_FPMulAddH(BigInt(32), v_st.f_gen_slice(v_st.f_gen_load(v_Exp90__2), BigInt(32), BigInt(32)), v_st.f_gen_append_bits(BigInt(1), BigInt(15), v_st.f_gen_not_bits(BigInt(1), v_st.f_gen_slice(v_st.f_gen_load(v_Exp82__3), BigInt(31), BigInt(1))), v_st.f_gen_slice(v_st.f_gen_load(v_Exp82__3), BigInt(16), BigInt(15))), v_st.f_gen_slice(v_st.f_gen_load(v_Exp87__3), BigInt(16), BigInt(16)), v_st.f_gen_load(v_st.v_FPCR.v)))
      ...
      v_st.f_gen_store (v_Exp115__2,v_st.f_gen_FPMulAddH(BigInt(32), v_st.f_gen_slice(v_st.f_gen_load(v_Exp90__2), BigInt(32), BigInt(32)), v_st.f_gen_slice(v_st.f_gen_load(v_Exp82__3), BigInt(16), BigInt(16)), v_st.f_gen_slice(v_st.f_gen_load(v_Exp87__3), BigInt(16), BigInt(16)), v_st.f_gen_load(v_st.v_FPCR.v)))
